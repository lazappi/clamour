...
An analysis of tweets for the query `r hashtag_query` related to {{DESCRIPTION}} 
from `r params$start_day` to `r params$end_day`. A total of `r nrow(tweets)`
tweets from `r  length(unique(tweets$screen_name))` users were  collected using
the **{rtweet}** R package.
